...
public class CapturedPokemonRecyclerViewAdapter extends RecyclerView.Adapter<CapturedPokemonRecyclerViewAdapter.ViewHolder> {
    ...
    public CapturedPokemonRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(FragmentCapturedPokemonBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(FragmentCapturedPokemonBinding binding) {
